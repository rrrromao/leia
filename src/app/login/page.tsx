...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-neutral-50">
      <form onSubmit={submit} className="w-full max-w-sm bg-white p-6 rounded-2xl border border-neutral-200 shadow-sm space-y-4">
        ...
        <button
          disabled={loading}
          className="w-full rounded-xl bg-black text-white py-2 text-sm font-medium hover:opacity-90 disabled:opacity-50"
        >
