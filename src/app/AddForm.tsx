...
export default function AddForm({ onDone }: Props) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-start justify-center bg-black/30 p-4 pt-24">
      <form onSubmit={handleSubmit} className="w-full max-w-xl rounded-2xl border border-neutral-200 bg-white p-6 shadow-lg">
        ...
        <div className="mt-6 flex items-center justify-end gap-3">
          <button
            type="button"
            onClick={() => { reset(); setOpen(false); }}
            className="text-sm px-4 py-2 rounded-xl border border-neutral-300 text-neutral-900 hover:bg-neutral-50"
          >
            Cancelar
          </button>
          <button
            type="submit"
            disabled={loading}
            className="text-sm px-4 py-2 rounded-xl bg-black text-white hover:opacity-80 disabled:opacity-50"
          >
